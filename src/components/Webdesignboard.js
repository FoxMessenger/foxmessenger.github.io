...
const Webdesignboard = () => (
    <div>
        ...
        <div className="col-span-4">
            ...
            <div className="dotted">&nbsp;</div>
            <div>
                <p className="font-light">Paper App</p>
                <div className="font-light font-sm">This web application was designed to give you a quick series of current Onion Related Articles taken from the Onion. The site contains a neat series of UX functions.
                </div>
            </div>
        </div>
        </div>
